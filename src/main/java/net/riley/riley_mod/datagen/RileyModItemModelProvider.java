...
public class RileyModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        soulItem(RileyModItems.BAT_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.ALLAY_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.AXOLOTL_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.BEE_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.BLAZE_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.CAT_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.CAMEL_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.CAVE_SPIDER_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.CHICKEN_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.COD_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.COW_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.DOLPHIN_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.DONKEY_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.DROWNED_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.ELDER_GUARDIAN_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.ENDERMAN_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.ENDERMITE_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.EVOKER_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.FOX_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.FROG_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.GHAST_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.GLOW_SQUID_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.GOAT_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.GUARDIAN_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.HOGLIN_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.HORSE_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.HUSK_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.IRON_GOLEM_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.LLAMA_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.MAGMA_CUBE_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.MOOSHROOM_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.MULE_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.OCELOT_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.PANDA_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.PARROT_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.PHANTOM_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.PIG_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.PIGLIN_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.PIGLIN_BRUTE_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.PILLAGER_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.POLAR_BEAR_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.PUFFERFISH_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.RABBIT_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.RAVAGER_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.SALMON_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.SHEEP_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.SHULKER_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.SILVERFISH_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.SKELETON_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.SKELETON_HORSE_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.SLIME_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.SNIFFER_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.SNOW_GOLEM_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.SPIDER_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.SQUID_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.STRAY_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.STRIDER_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.TADPOLE_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.TRADER_LLAMA_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.TROPICAL_FISH_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.TURTLE_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.VEX_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.VILLAGER_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.VINDICATOR_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.WANDERING_TRADER_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.WARDEN_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.WITCH_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.WITHER_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.WITHER_SKELETON_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.WOLF_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.ZOGLIN_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.ZOMBIE_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.ZOMBIE_HORSE_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.ZOMBIE_VILLAGER_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.ZOMBIFIED_PIGLIN_SOUL, modLoc("item/soul"));
        soulItem(RileyModItems.ENDER_DRAGON_SOUL, modLoc("item/soul"));
