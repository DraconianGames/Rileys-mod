...
public class RileyModAbyssTeleporter implements ITeleporter {
    private final BlockPos thisPos;
    public static boolean insideDimension = true;

    public RileyModAbyssTeleporter(BlockPos pos, boolean insideDim) {
        thisPos = pos;
    ...
    public Entity placeEntity(Entity entity, ServerLevel currentWorld, ServerLevel destinationWorld,
        ...
        Direction.Axis axis = portalState.hasProperty(RileyModAbyssPortalBlock.AXIS) ? portalState.getValue(RileyModAbyssPortalBlock.AXIS) : Direction.Axis.X;
    ...
    private void buildPortal(ServerLevel world, BlockPos pos) {
        ...
        BlockState portal = RileyModBlocks.ABYSS_PORTAL.get().defaultBlockState().setValue(RileyModAbyssPortalBlock.AXIS, Direction.Axis.X);
