...
public class WhaleHunterTrophyBlock extends Block {
    ...
    private static final VoxelShape SHAPE = Shapes.box(-1.0, 0.0, -1.0, 2.0, 1.5, 2.0);

    public WhaleHunterTrophyBlock(Properties pProperties) {
        super(pProperties);
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable BlockGetter pLevel, List<Component> pTooltip, TooltipFlag pFlag) {
        pTooltip.add(Component.translatable("item.riley_mod.whale_hunter_trophy.tooltip"));
