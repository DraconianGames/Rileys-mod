...
public class RapterAttackGoal extends MeleeAttackGoal {
    private final RapterEntity entity;
    private int attackDelay = 12;
    private int ticksUntilNextAttack= 3;
    private boolean shouldCountTillNextAttack = false;


    public RapterAttackGoal(PathfinderMob pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
        super(pMob, pSpeedModifier, pFollowingTargetEvenIfNotSeen);
        entity =((RapterEntity) pMob);
    }
