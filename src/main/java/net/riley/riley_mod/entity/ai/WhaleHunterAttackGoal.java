...
public class WhaleHunterAttackGoal extends MeleeAttackGoal {

    private final WhaleHunterEntity entity;
    private int attackDelay = 15;
    private int ticksUntilNextAttack= 5;
    private boolean shouldCountTillNextAttack = false;

    public WhaleHunterAttackGoal(PathfinderMob pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
        super(pMob, pSpeedModifier, pFollowingTargetEvenIfNotSeen);
        entity =((WhaleHunterEntity) pMob);
    }
    @Override
    public void start() {
        super.start();
