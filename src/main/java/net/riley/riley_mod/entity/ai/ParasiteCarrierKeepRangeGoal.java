...
public class ParasiteCarrierKeepRangeGoal extends Goal {
    ...
    public ParasiteCarrierKeepRangeGoal(ParasiteCarrierEntity rex, double speed, double minRange, double maxRange) {
        this.rex = rex;
        this.speed = speed;
