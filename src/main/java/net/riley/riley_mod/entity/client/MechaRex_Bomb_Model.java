...
public class MechaRex_Bomb_Model<T extends Entity> extends HierarchicalModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "mecharex_bomb"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(14, 42).addBox(-2.0F, -2.0F, 6.0F, 4.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 18.0F, 0.0F));
