...
public class JournalScreen extends Screen {
    ...
    public JournalScreen() {
        ...
        // Creatures
        ALL_ENTRIES.add(new JournalEntry("Bison","A new animal spawing only in the plains biome. Tame it like a horse.", JournalEntry.Category.CREATURES,RileyModEntities.BISON.get(), 22.0f, Items.CARROT,
        ...
        ALL_ENTRIES.add(new JournalEntry("Sunless Crab", " They do like amethyst shards, and are neutral.", JournalEntry.Category.CREATURES, RileyModEntities.SUNLESS_CRAB.get(),22.0f, Items.AMETHYST_SHARD
                ,java.util.List.of(),null));
        ALL_ENTRIES.add(new JournalEntry("Whale Hunter", "A massive predator deep sea predator. They are neutral. They don't like boats.", JournalEntry.Category.CREATURES, RileyModEntities.WHALE_HUNTER.get(),5.0f,null,
                java.util.List.of(),null));
        ...
        ALL_ENTRIES.add(new JournalEntry("Night Terror","A Winged Nightmare that loves flying way too much. It's roar will make you go deaf temporary", JournalEntry.Category.CREATURES, RileyModEntities.NIGHT_TERROR.get(),7.0f, RileyModItems.CLAW.get(),
