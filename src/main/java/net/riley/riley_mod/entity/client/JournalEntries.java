...
public final class JournalEntries {
    ...
    public static List<JournalEntry> create() {
        ...
        new JournalEntry("Sunless Crab", " They do like amethyst shards, and are neutral.", JournalEntry.Category.CREATURES, RileyModEntities.SUNLESS_CRAB.get(), Items.AMETHYST_SHARD
                ,java.util.List.of(),null),
        new JournalEntry("Whale Hunter", "A massive predator deep sea predator. They are neutral. They don't like boats.", JournalEntry.Category.CREATURES, RileyModEntities.WHALE_HUNTER.get(),null,
                java.util.List.of(),null),
        new JournalEntry("Rapter", "Loves cooked rabbit. They are neutral, but they are opportunistic. They are stronger than their cousin the Frost Hopper.", JournalEntry.Category.CREATURES, RileyModEntities.RAPTER.get(),net.minecraft.world.item.Items.COOKED_RABBIT,
                java.util.List.of(new MobEffectInstance(RileyModEffects.BLEED.get(), 100, 0)),null),
        new JournalEntry("Night Terror","A Winged Nightmare that loves flying way too much. It's roar will make you go deaf temporary", JournalEntry.Category.CREATURES, RileyModEntities.NIGHT_TERROR.get(), RileyModItems.CLAW.get(),
                java.util.List.of(new MobEffectInstance(RileyModEffects.DEAF.get(), 6000, 0)),null),
        new JournalEntry("Frost Hopper","Lives Obsidian Peaks in the abyss. Smaller than they rapter, they developed a poison that will freeze you in place, it comes out of the horn on their forehead. They hunt in packs.", JournalEntry.Category.CREATURES, RileyModEntities.FROST_HOPPER.get(),net.minecraft.world.item.Items.COOKED_RABBIT,
                java.util.List.of(new MobEffectInstance(RileyModEffects.FREEZE.get(), 60, 0)),null),
        new JournalEntry("Tooth Fairy", "An extremely docile creature looking for protection. They are more useless than a bat. They do like bones for some reason.", JournalEntry.Category.CREATURES, RileyModEntities.TOOTHFAIRY.get(), RileyModItems.TOOTH.get(),
                java.util.List.of(),null),
        new JournalEntry("Bone Fairy", "The larger, much deadlier evolutionary cousin of the Tooth Fairy. It can throw a pretty good punch. They do like skeleton skulls for some reason.", JournalEntry.Category.CREATURES, RileyModEntities.BONEFAIRY.get(), RileyModItems.TOOTH.get(),
                java.util.List.of(),null),
        new JournalEntry("Skeleton Fairy", "After countless fights, the Bone Fairie's claws wore down, force to only be used as feet. It grew too heavy to stand upright, and developed a nice set of fangs. It also developed more eyes for better precision.", JournalEntry.Category.CREATURES, RileyModEntities.SKELETONFAIRY.get(), RileyModItems.TOOTH.get(),
                java.util.List.of(),null),
        new JournalEntry("Skull Fairy","The final evolution of the tooth fairy. It is now fire proof.", JournalEntry.Category.CREATURES, RileyModEntities.SKULL_FAIRY.get(),  RileyModItems.TOOTH.get(),
                java.util.List.of(),null),
        new JournalEntry("Mecha Rex", "Only found within a strange arena in the Fallow. Its missiles will track their target.", JournalEntry.Category.CREATURES, RileyModEntities.MECHAREX.get(),  null,
                java.util.List.of(),null),
