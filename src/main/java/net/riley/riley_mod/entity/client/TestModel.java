...
public class TestModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public TestModel(ModelPart root) {
		...
		this.yum = this.body.getChild("yum");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition yum = body.addOrReplaceChild("yum", CubeListBuilder.create().texOffs(0, 20).addBox(-4.5F, -9.5F, -4.5F, 9.0F, 9.0F, 9.0F, new CubeDeformation(0.0F))
		.texOffs(0, 0).addBox(-5.0F, -10.0F, -5.0F, 10.0F, 10.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
