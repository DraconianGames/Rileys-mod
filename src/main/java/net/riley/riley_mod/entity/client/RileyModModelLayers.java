...
public static final ModelLayerLocation BISON_LAYER = new ModelLayerLocation(
    ...
    public static final ModelLayerLocation TEST_LAYER = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(RileyMod.MODID, "test_layer"),"main");
    ...
    public static final ModelLayerLocation SKY_QUADSON_LAYER = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(RileyMod.MODID, "sky_quadson_layer"),"main");
    ...
    public static final ModelLayerLocation TRUCK_LAYER = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(RileyMod.MODID, "truck_layer"),"main");
    public static final ModelLayerLocation TRUCK_WRECKER_UPGRADE_LAYER = new ModelLayerLocation(
