...
public class FrostHopperAnimationDefinitions {
    public static final AnimationDefinition FROST_HOPPER_IDLE = AnimationDefinition.Builder.withLength(1.0F).looping()
            ...
            .addAnimation("head", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(0.75F, KeyframeAnimations.degreeVec(0.0F, 0.0F, -25.67F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(1.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
            ))
            .build();

    public static final AnimationDefinition FROST_HOPPER_ATTACK = AnimationDefinition.Builder.withLength(0.75F).looping()
            .addAnimation("head", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
    ...
    public static final AnimationDefinition FROST_HOPPER_WALK = AnimationDefinition.Builder.withLength(0.5F).looping()
            .addAnimation("frosthopper", new AnimationChannel(AnimationChannel.Targets.POSITION,
