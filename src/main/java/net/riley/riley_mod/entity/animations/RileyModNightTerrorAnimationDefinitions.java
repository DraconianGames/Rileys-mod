...
public class RileyModNightTerrorAnimationDefinitions {
        public static final AnimationDefinition NIGHT_TERROR_ATTACK = AnimationDefinition.Builder.withLength(0.75F).looping()
        ...
        public static final AnimationDefinition NIGHT_TERROR_FLY = AnimationDefinition.Builder.withLength(0.75F).looping()
                ...
                .addAnimation("leftwingend", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                ...
                .addAnimation("rightwingend", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                        new Keyframe(0.25F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 40.0F), AnimationChannel.Interpolations.LINEAR),
                        new Keyframe(0.5F, KeyframeAnimations.degreeVec(0.0F, 0.0F, -60.0F), AnimationChannel.Interpolations.LINEAR),
                        new Keyframe(0.75F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
