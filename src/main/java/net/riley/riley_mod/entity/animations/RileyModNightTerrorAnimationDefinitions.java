...
public class RileyModNightTerrorAnimationDefinitions {
        public static final AnimationDefinition NIGHT_TERROR_ROAR = AnimationDefinition.Builder.withLength(2.0F).looping()
                ...
                .addAnimation("upjaw", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                        new Keyframe(0.3333F, KeyframeAnimations.degreeVec(-130.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                ...
                .addAnimation("lowerjaw", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        ...
                        new Keyframe(1.5417F, KeyframeAnimations.degreeVec(62.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                        new Keyframe(2.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
                ))
                .build();
