...
public class ToothFairyAnimationDefinitions {
    public static final AnimationDefinition TOOTHFAIRY_SIT = AnimationDefinition.Builder.withLength(0.25F).looping()
    ...
    public static final AnimationDefinition TOOTHFAIRY_BEG = AnimationDefinition.Builder.withLength(0.1667F).looping()
            ...
            .build();
    public static final AnimationDefinition TOOTHFAIRY_WALK = AnimationDefinition.Builder.withLength(1.0F).looping()
            .addAnimation("head", new AnimationChannel(AnimationChannel.Targets.ROTATION,
    ...
    public static final AnimationDefinition TOOTHFAIRY_IDLE = AnimationDefinition.Builder.withLength(0.25F).looping()
            .addAnimation("body", new AnimationChannel(AnimationChannel.Targets.ROTATION,
