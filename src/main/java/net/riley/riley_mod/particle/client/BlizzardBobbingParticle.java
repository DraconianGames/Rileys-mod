...
public class BlizzardBobbingParticle extends TextureSheetParticle {

    private final SpriteSet spriteSet;
    private final int phaseOffset;

    protected BlizzardBobbingParticle(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
            ...
            return new BlizzardBobbingParticle(level, x, y, z, xd, yd, zd, sprites);
        }
    }
}